...
import TestimonialImage01 from '../images/ceo.jpg';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Founder's Message</h2>
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 lg:max-w-none">
            ...
            {/* 2nd testimonial */}
            <div className="flex flex-col h-full p-6 bg-gray-800 col-span-1 lg:col-start-2" data-aos="fade-up">
              <div>
                <div className="relative inline-flex flex-col mb-4">
              ...
              <blockquote className="text-lg text-gray-400 grow">— In an age where digital manipulation is easier than ever, we believe authenticity should be the foundation of media. Our platform is here to empower creators and consumers alike to trust what they share and see.</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Gurjap Hajra</cite>
                - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Founder</a>
              </div>
            </div>
